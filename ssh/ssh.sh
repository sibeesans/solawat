...
wget -q -O /usr/local/geovpn/ws-epro "https://raw.githubusercontent.com/jaka1m/project/main/ws/ws-epro"
chmod +x /usr/local/geovpn/ws-epro
wget -q -O /etc/geovpn/ws-epro.conf "https://raw.githubusercontent.com/jaka1m/project/main/ws/ws-epro.conf"
chmod 644 /etc/geovpn/ws-epro.conf
wget -q -O /etc/systemd/system/ws-epro.service "https://raw.githubusercontent.com/jaka1m/project/main/ws/ws-epro.service"
