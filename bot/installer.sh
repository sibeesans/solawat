...
surat=$(curl -sS https://raw.githubusercontent.com/jaka1m/ipmulti/main/ipmini | grep -w $ipes | awk '{print $4}')
...
EOF
    ...
    fun_bot1() {
      [[ ! -e "/etc/.maAsiss/.Shellbtsss" ]] && {
        wget -qO- https://raw.githubusercontent.com/jaka1m/project/main/bot/BotAPI.sh >/etc/.maAsiss/.Shellbtsss
      }
